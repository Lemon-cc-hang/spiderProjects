...
class Get_url5:
    ...
    def __init__(self):
        ...
        with open('urls/5.txt', 'r')as f:
            self.urls = f.readline().split(',')
        with open('urls/5.txt', 'w')as f:
            pass
    ...
    def parse(self, html, url):
        ...
        name = soup.select_one('.namebar.clearfix h2')

        # print(name)
        if name:
            with open('urls/5.txt', 'a+') as f:
                f.write(url + ',')
        else:
            with open('urls/others.txt', 'a+')as f:
                f.write(url + ',')
